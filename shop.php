...
<head>
    ...
    <link rel='icon' href='app/img/logosf.png' type='image/png'>
    <title>VILA NORTE SP ROLEPLAY</title>
</head>
...
<body class="modal-open" style="overflow-x: hidden; padding-right: 0px;" data-bs-overflow="hidden" data-bs-padding-right="0px">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-md">
            <a class="navbar-brand" href="#"><img id="imglogo" src="app/img/logosf.png"></a>
    ...
    <div class="content mt-7">
        ...
        <div class="row">
                <div class="text-center">
                    <p class="title" data-text="VILA NORTE SP ROLEPLAY">VILA NORTE SP ROLEPLAY</p>
                    ...
                    <div class="shop">
                        <div class="shop-content">
                            <div class="shop-content-header">
                                ...
                                <p class="description"><b>NOTRYPOINTS</b> são a nova moeda exclusiva da city! Você pode usá-los para adquirir VIP exclusivos no jogo desde de <b>vantagens</b> pro seu personagem.</p>
                            </div>
    ...
    <div class="footer" style="margin-top: 50px">
        ...
        <p class="enterprise">Copyright © 2023 - <span>VILA NORTE SP ROLEPLAY</span></p>
...
$json_data = json_encode([
    ...
    "embeds" => [
        [
            ...
            // Footer
            "footer" => [
                "text" => "Coypright © VILA NORTE SP ROLEPLAY",
            ],
        ]
    ]
